...
//=============================================================================
/*:
 * @plugindesc (v1.0) Sistema de mapa de teleporte rápido.
 * @author Moghunter
 *
...
// ** TOWNS
//=============================================================================	
    Moghunter.fastTravel_Towns[1] = {name:"アガデス王国",x:550,y:400,mapID:5,mapX:9,mapY:2,direction:2};
    Moghunter.fastTravel_Towns[2] = {name:"ケテルマル王国",x:530,y:320,mapID:6,mapX:17,mapY:11,direction:4};
//=============================================================================
// ** DUNGEONS
//=============================================================================	
...
SceneFastTravel.prototype.refreshStage = function() {
     var name = "map" + String(this._currentData.mapID);
     var vid = 0
     $gameVariables.setValue(591, " ");
     if(this._currentData.mapID==5) vid = 592
     if(this._currentData.mapID==6) vid = 593
     var message = " "
     if(vid != 0){
        $gameVariables.setValue(591, $gameVariables.value(vid));
        var mes = $gameVariables.value(591)
        if(mes != 0){
          var me1 = mes[0]
          var me2 = mes[1]
          var me3 = mes[2]
          var message = "食料:-" + mes[0] + "　Ｓ:-" + mes[1] + "　時間:+" + mes[2] + "日"
        }
     }
     
     this._comp.bitmap.clear();
     this._comp.bitmap.drawText(message,40,0,350,32, "left");
     if(vid != 0) $gameVariables.setValue(591, $gameVariables.value(vid));
...
SceneFastTravel.prototype.createCompleted = function() {
	 this._comp = new Sprite(new Bitmap(400,152));
     this._comp.x = 40//Moghunter.fastTravel_Comp_X
	 this._comp.y = 360//Moghunter.fastTravel_Comp_Y
	 ...
	 var total = $gameVariables.value(591)
     this._comp.bitmap.drawText(total,0,0,400,32, "center");
